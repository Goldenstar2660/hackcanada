...
pi:
	@if [ -f devices/pi-station/pyproject.toml ]; then cd devices/pi-station && uv run python -m binsight_station.main; else echo "devices/pi-station is not bootstrapped yet."; fi
