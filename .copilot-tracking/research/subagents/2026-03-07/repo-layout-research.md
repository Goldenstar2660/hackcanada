...
description: Research document for the recommended top-level repository layout for the Binsight project
...
* Determine the best top-level repository layout for a greenfield Binsight repository.
