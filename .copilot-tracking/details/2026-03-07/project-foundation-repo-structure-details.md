...
Sources: .copilot-tracking/research/2026-03-07/project-foundation-repo-structure-research.md, spec/binbuddy-spec.md, /memories/repo/foundation.md
...
* spec/binbuddy-spec.md (Lines 134-145) - Hardware split and Firebase placement constraints
...
* devices/pi-station/src/binbuddy_station/__init__.py - Package marker
* devices/pi-station/src/binbuddy_station/main.py - Runtime entry point placeholder
...
* spec/binbuddy-spec.md (Lines 17-40) - Live session and disposal logic owned by station runtime
...
Files:
* devices/pi-station/src/binbuddy_station/session.py - Session state machine boundary
* devices/pi-station/src/binbuddy_station/classification.py - Local and fallback classification boundary
* devices/pi-station/src/binbuddy_station/rules.py - Active rules preset application boundary
* devices/pi-station/src/binbuddy_station/esp_client.py - ESP protocol translation boundary
* devices/pi-station/src/binbuddy_station/live_status.py - Firebase live status publishing boundary
* devices/pi-station/src/binbuddy_station/events.py - Disposal event creation boundary
...
* spec/binbuddy-spec.md (Lines 11-64) - End-to-end live guidance and event flow
...
* spec/binbuddy-spec.md (Lines 134-145) - ESP8266 hardware notes
...
* spec/binbuddy-spec.md (Lines 43-90) - Required event fields, metrics, and dashboard features
...
* spec/binbuddy-spec.md (Lines 65-90) - Tracked metrics and definitions
...
* spec/binbuddy-spec.md (Lines 142-145) - Firestore and Cloud Functions placement
